/**
 * Use array skills on magpie chatbot program
 * 3-13-2021
 * Ryan Wagner
 */
public class Magpie4
{
    ...
    public String getResponse(String statement)
    {
        ...
        else if (findKeyword(statement, "I want to", 0) >= 0)
        {
            ...
            response = iSomethingYou(statement);
        }
        else
        {
    ...
    private String iSomethingYou(String statement){
        statement = statement.trim();
        int position = findKeyword(statement, "you", 0);
        String something = statement.substring(2, position);
    ...
    private String getRandomResponse()
    {
        ...
        String[] randResp = new String[6];
        randResp[0] = "Interesting, tell me more.";
        randResp[1] = "Hmmm.";
        randResp[2] = "Do you really think so?";
        randResp[3] = "You don't say.";
        randResp[4] = "Really, what else?";
        randResp[5] = "Oh ok";
       
        return randResp[whichResponse];
    }
